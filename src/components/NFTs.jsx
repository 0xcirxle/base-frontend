...
import FloatingOverlay from './Nft';
  ...
  return (
    <div>
        <main className='bg-[#131313] p-2 rounded-3xl rounded-tl-none pt-6 mt-[60px]'>
            ...
            <div className="bg-transparent p-4 ml-[-6px] rounded-lg mt-[-36px]">
                <div className="grid grid-cols-3 gap-4">
                <div className="col-span-2 bg-[#1E1E1E] rounded-lg p-4">
                    <div className="flex justify-between items-center mb-4">
                    <h3 className="font-bold">Tokens Worth</h3>
                    <div className="flex space-x-2">
                        <button className="bg-transparent px-2 py-1 rounded-md text-sm font-semibold">
                        24H
                        </button>
                        <button className="bg-white px-3 h-[20px] mt-1 rounded-md text-black text-sm font-semibold">
                        7D
                        </button>
                        {['30D', '6M'].map((period) => (
                        <button key={period} className="bg-transparent px-2 py-1 rounded-md text-sm font-semibold">
                            {period}
                        </button>
                        ))}
                    </div>
                ...
                <div className="bg-[#1E1E1E] rounded-lg p-4">
                    ...
                    <button className="w-full mt-32 bg-[#DA0046] text-white rounded-md py-2">
                    OPEN NFTS
                    </button>
                </div>
                </div>
